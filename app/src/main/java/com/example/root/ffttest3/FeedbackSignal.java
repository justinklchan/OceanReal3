...
//        }
    ...
    public static int[] expand_freqs(int[] freqs) {
        ...
        int numbins = (int)Math.floor((freqs[freqs.length-1]-freqs[0])/freqSpacing);
...
//            f1=(int)Math.ceil(f1/(double)Constants.inc)*Constants.inc;
//            f2=(int)Math.floor(f2/(double)Constants.inc)*Constants.inc;

...
//        short[] txsig = SymbolGeneration.generate(bits, valid_bins, Constants.data_symreps, true);
    ...
    public static void feedback_test2() {
        double[] fback = FileOperations.readrawasset(MainActivity.av, R.raw.spec1,1);
...
//        double[] sig = FileOperations.readfrofmfile(MainActivity.av, "Bob-Sounding-0-1642631211115-bottom");
